...
<div class="library-search-content-top col-sm-12">
    <p>The Resource Center's virtual library collects material from a wide array of organizations available in a variety of formats to build a knowledge base around healthy marriage and relationship education, integration into safety-net service systems, and related topics for couples, educators, policy makers, public service agencies, and other safety-net stakeholders.</p>
    <p>Visit our Special Collection: <a href="/special-collections" title="Healthy Dating Leads to Healthy Marriage Special Collection">Healthy Dating Leads to Healthy Marriage</a> for resources for youth, parents and service providers on this important topic.</p>
    <p>Use the search options provided below to find resources that you are interested in. If you have additional questions, please <a href="/contact-us" title="Contact Us page">contact us</a> directly.</p>
</div>
