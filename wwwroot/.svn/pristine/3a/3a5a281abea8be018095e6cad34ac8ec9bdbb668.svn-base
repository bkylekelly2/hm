...
<div class="main-container container">
  ...
  <div class="row">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <div class="library-search-content-bottom sc-content-bottom col-sm-12">
      ...
      <div class="col-sm-3">
          <p><a href="/library-resource-submission-policy" id="library-submission-policy-link" name="Submit Library Resource" value="Submit Library Resource" class="btn btn-primary">Submit Library Resource</a>
          </p>
          <p><a href="/library-search-results" id="library-search-results-link" name="Search All Resources" value="Search All Resources" class="btn btn-primary">Search All Resources</a>
          </p></div>
      </div>
