...
<head>
	...
	<?php if (theme_get_setting('toggle_favicon')): ?>
      <link rel='shortcut icon'
            href='<?php print theme_get_setting('favicon') ?>'
            type='image/x-icon'/>
	<?php endif; ?>
	<?php print $css; ?>
</head>
...
<div id="nhmrc_certif">
    <img style="background-color: transparent;"
         src="/sites/all/themes/bootstrap_nhmrc/images/logo-maintain.png"
         alt="Healthy Marriage logo" class="nhmrc_cert_logo"/>
    <br/>
    <h1 class="page-title">Certificate of Attendance</h1>
    <p>This acknowledges that</p>
    <div class="cert-variable">
        <p class="nhmrc_cert_name">
					<?php print  $_REQUEST['name']; ?>
        </p>
        <p>
            participated in a National Resource Center for Healthy Marriage and
            Families <?php print $_REQUEST['category']; ?>
        </p>
        <p class="nhmrc_cert_course">
					<?php print $_REQUEST['course']; ?>
        </p>
        <p class="cert_date">    <?php print $_REQUEST['date']; ?>
        </p>
        <p class="cert_length">This certificate
            validates <?php print $_REQUEST['length']; ?> of professional
            development activity</p>

    </div>

    <div class="cert_bottom">
        <div class="div-cert-today" s>
        <span class="cert_today">
            Awarded on <?php
		        $date = date('F d, Y');
		        print $date;
	        ?>
        ...
        <div class="div-cert-signature">
            <span><img src="/sites/all/themes/bootstrap_nhmrc/images/signature.PNG" alt="signature" class="nhmrc_cert_signature"/></span>
        </div>
    </div>
